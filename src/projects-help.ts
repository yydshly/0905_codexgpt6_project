...
export function mountProjectsHelp(header:HTMLElement,startNew:()=>void,canStart:()=>boolean){
  ...
  entry.onclick=()=>{
    ...
    dialog.innerHTML=`<header class="help-heading"><div><span class="project-overline">A LITTLE GUIDANCE</span><h2 id="projects-help-title">理想书房 · 使用指南</h2></div><button type="button" class="help-close" aria-label="关闭使用帮助" autofocus>×</button></header>
      ...
      <details><summary>怎样切换工程、复制或另存为？</summary><div class="help-answer"><dl><dt>切换</dt><dd>当前页面右上「我的工程」→「保存并返回工程库」，再打开另一张卡片。</dd><dt>复制已保存内容</dt><dd>工程卡片上的「复制工程」。副本独立保存，从版本 1 开始。</dd><dt>保留当前修改，尝试新方向</dt><dd>编辑器右上「我的工程」→ 填写新名称 →「另存为新工程」。当前未保存内容也会进入副本，原工程保持原样。</dd></dl></div></details>
      ...
      <details><summary>怎样找回以前保存的版本？</summary><div class="help-answer"><p>在工程卡片点击「保存版本」，找到需要的版本 →「恢复此版本」→「确认恢复」。也可以从编辑器「我的工程」→「查看保存版本」进入。</p><p>有内容变化的保存会留下新版本；恢复旧内容会追加一个版本，恢复前的版本仍然保留，可以再次找回。</p><p class="help-note"><strong>保存版本与撤销不同：</strong>保存版本可跨刷新恢复；每次拖动、修改对应的撤销记录只保留在当前编辑会话。重要修改完成后记得保存。</p></div></details>
